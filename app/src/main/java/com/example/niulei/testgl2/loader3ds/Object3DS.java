...
public class Object3DS {
	 ...
	 */
	public void draw(float[] mvp,int mMVPMatrixHandle,int mPositionHandle, int mNormalHandle, int mTextureCoordinateHandle, int textureSamplerHandle, int mMVMatrixHandle) {
